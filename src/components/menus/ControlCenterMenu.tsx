  ...
  return (
    ...
    >
      <div className="cc-grid row-span-2 col-span-2 p-2 flex flex-col justify-around">
        <div className="hstack space-x-2">
          ...
          <div p="t-0.5">
            ...
            <div className="cc-text">{wifi ? "已连接" : "关闭"}</div>
          </div>
        </div>
        <div className="hstack space-x-2">
          <div
          ...
          <div p="t-0.5">
            <div className="font-medium leading-4">蓝牙</div>
            <div className="cc-text">{bluetooth ? "开启" : "关闭"}</div>
          </div>
        </div>
        <div className="hstack space-x-2">
          <div
          ...
          <div p="t-0.5">
            <div className="font-medium leading-4">隙投</div>
            <div className="cc-text">{airdrop ? "仅联系人" : "关闭"}</div>
          </div>
        </div>
      </div>
      <div className="cc-grid col-span-2 p-2 hstack space-x-3">
        ...
        <div font-medium>{dark ? "深色模式" : "浅色模式"}</div>
      </div>
      ...
      <div className="cc-grid col-span-4 px-2.5 py-2 space-y-1 flex flex-col justify-around">
        <span className="font-medium ml-0.5">显示器</span>
        <SliderComponent icon="i-ion:sunny" value={brightness} setValue={setBrightness} />
      </div>
      <div className="cc-grid col-span-4 px-2.5 py-2 space-y-1 flex flex-col justify-around">
        <span className="font-medium ml-0.5">声音</span>
